...
% Ck = Ck + opt.erg.Ck;
% [Ergodicity_Metric] = Calculate_Ergodicity(Ck*opt.dt/opt.tf, opt.erg.muk, DomainBounds);
[Ergodicity_Metric] = Calculate_Ergodicity(Ck/(Nsteps*opt.currentStage*opt.dt), opt.erg.muk, DomainBounds);
