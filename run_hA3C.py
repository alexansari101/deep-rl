...
def process_args(args):
    ...
    if(args.load):
        args.output, iter_num = dir_utils.get_saved(args.output, args.env, args.run, args.iter)
        args.iter = iter_num
    else:
        args.output = dir_utils.get_output_folder(args.output, args.env)
...
def main():  # noqa: D103
    ...
    parser.add_argument('--iter', default=0, type=int, help='The iter to load')
